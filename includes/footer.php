...
<head>
  ...
  <title>Footer Sosial Media</title>
  ...
  <style>
    ...
    .footer-wrapper {
      margin-left: 200px; /* sesuaikan dengan lebar sidebar kamu */
    }
  </style>
</head>
...
<body>
  ...
  <div class="footer-wrapper mt-5">
    <footer class="bg-light text-center text-white w-100">
      <!-- Grid container -->
      <div class="p-4 pb-0">
        ...
        <section class="mb-4 d-flex justify-content-center">
          ...
          <!-- Github -->
          <a class="btn btn-primary btn-floating m-1" style="background-color: #333333;" href="https://github.com/MFRidwan" target="_blank" role="button">
